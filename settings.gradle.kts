...
// `kit/jvm-spring`, `tools/demo-app`). The root `build.gradle.kts` centers
// the Kotlin plugin. A later issue can add a convention plugin for the
// toolchain and the test setup.
